package com.changhr.datasync.job;
...
public class SyncXxlJob {
    private static Logger logger = LoggerFactory.getLogger(SyncXxlJob.class);
     ...
     * 1、简单任务示例（Bean模式）
     */
    @XxlJob("userTableSyncJobHandler")
    public void userTableSyncJobHandler() throws Exception {
        XxlJobHelper.log("Sync User Table.");
